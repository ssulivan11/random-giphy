...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var restore = function () { return storage.get(tag.name, function (value) { return tag.changeTo(value); }); };
    restore();
...
var ResetButton = function (button) {
    var onClick = function (callback) { return button.addEventListener('click', callback); };
...
var SaveForm = function (form) {
    var onSubmit = function (callback) { return form.addEventListener('submit', callback); };
    return { onSubmit: onSubmit };
};
var getElement = function (name) { return document.getElementById(name); };
